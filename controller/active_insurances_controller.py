...
class ActiveInsuranceController:
    ...
    def save(cls, insurance_id, service, number_of_duration, duration_period, cost, customer_id):
        active_insurance = ActiveInsurance(insurance_id, service, number_of_duration, duration_period, cost,
                                           customer_id)
    ...
    def find_by_insurance_id(cls, insurance_id):
        return True, cls.active_insurance_da.find_by_insurance_id(insurance_id)

    @classmethod
    @exception_handling
    def find_by_active_insurance_id(cls, active_insurance_id):
        return True, cls.active_insurance_da.find_by_active_insurance_id(active_insurance_id)
